...
# df= pd.read_csv('/Users/smesbah/Downloads/pgpr-master/input/Batch_renewableenergy_crowd.csv')
...
count=0
mylist=[]
with open('/Users/smesbah/Downloads/pgpr-master/input_renewableenergy/labeled_data_idea.csv', 'w', newline='') as file:
               ...
               #  print(row['Input.variable_name'])
                ...
                if temp!=None and temp!=[]:
                    try:
                        ...
                        if temp[0] in row2[27] and temp[1] in row2[27] and temp[2] in row2[27] :
                            check=True
                            count = count + 1
                            #print(row2[27])
                            #print(row2[27])
...
with open('/Users/smesbah/Downloads/pgpr-master/input_renewableenergy/answer_matrix_overall.csv', 'w', newline='') as file:
        writer = csv.writer(file)
...
with open('/Users/smesbah/Downloads/pgpr-master/input_renewableenergy/answer_matrix_desirability.csv', 'w', newline='') as file:
    writer = csv.writer(file)
    writer.writerow(['idea', 'worker', 'rating'])
...
with open('/Users/smesbah/Downloads/pgpr-master/input_renewableenergy/answer_matrix_feasibility.csv', 'w', newline='') as file:
    writer = csv.writer(file)
    writer.writerow(['idea', 'worker', 'rating'])
    for row in list_feasibility:
        writer.writerow(row)
with open('/Users/smesbah/Downloads/pgpr-master/input_renewableenergy/answer_matrix_viability.csv', 'w', newline='') as file:
    writer = csv.writer(file)
    writer.writerow(['idea', 'worker', 'rating'])
    for row in list_viability:
        writer.writerow(row)

with open('/Users/smesbah/Downloads/pgpr-master/input_renewableenergy/answer_matrix_unlabeled_overall.csv', 'w', newline='') as file:
        writer = csv.writer(file)
        writer.writerow(['idea', 'worker', 'rating'])
        for row in list_overall_un:
            writer.writerow(row)

with open('/Users/smesbah/Downloads/pgpr-master/input_renewableenergy/answer_matrix_unlabeled_desirability.csv', 'w', newline='') as file:
    writer = csv.writer(file)
    writer.writerow(['idea', 'worker', 'rating'])
    for row in list_desirability_un:
        writer.writerow(row)

with open('/Users/smesbah/Downloads/pgpr-master/input_renewableenergy/answer_matrix_unlabeled_feasibility.csv', 'w', newline='') as file:
    writer = csv.writer(file)
    writer.writerow(['idea', 'worker', 'rating'])
    for row in list_feasibility_un:
        writer.writerow(row)
with open('/Users/smesbah/Downloads/pgpr-master/input_renewableenergy/answer_matrix_unlabeled_viability.csv', 'w', newline='') as file:
    writer = csv.writer(file)
    writer.writerow(['idea', 'worker', 'rating'])
...
with open('/Users/smesbah/Downloads/pgpr-master/input_renewableenergy/unlabeled_data_idea.csv', 'w', newline='') as file:
        writer = csv.writer(file)

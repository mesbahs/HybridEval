...
import re
inputToken = '((('
# df1=pd.read_csv('/Users/smesbah/Downloads/pgpr-master/input/Batch_dementiafull.csv')
...
df1=pd.read_csv('/Users/smesbah/Downloads/pgpr-master/input/Batch_renewable_energy_both.csv')
df= pd.read_csv('/Users/smesbah/Downloads/pgpr-master/input/Batch_energy_summaryfinalversion.csv')
df=df.groupby("HITId").agg({"HITId":"first","Answer.Desirable":"mean", "Answer.feasible":"mean", "Answer.overall":"mean","Answer.viability":"mean","Input.variable_name":"first" ,"Answer.Desirable":"first","Answer.feasible":"first","Answer.overall":"first","Answer.viability":"first","Answer.clarityreason":"first","Answer.desirabilityreason":"first","Answer.feasibilereason":"first"})
list_desirability=[]
list_feasibility=[]
list_viability=[]
list_overall=[]
...
count=0
mylist=[]
with open('/Users/smesbah/Downloads/pgpr-master/input_renewableenergy_2/labeled_data_idea.csv', 'w', newline='') as file:
    ...
    for index, row in df.iterrows():
        ...
        # print(temp)\
        with open('/Users/smesbah/Downloads/pgpr-master/input/Batch_renewable_energy_both.csv', 'r') as file:
                ...
                if temp!=None and temp!=[]:
                    try:
                        ...
                        if temp[0] in row2[27] and temp[1] in row2[27]:
                            ...
                            print('EXPERT', row2[28],row2[32],row2[33],row2[34] ,row2[31],row2[29],row2[30])
                            print('CROWD::', row["Answer.Desirable"],row["Answer.feasible"], row["Answer.overall"],row["Answer.viability"],row["Answer.clarityreason"],row["Answer.desirabilityreason"],row["Answer.feasibilereason"])
                            my_text=''
                            for tt in temp:
                                my_text=my_text+' '+ tt
...
with open('/Users/smesbah/Downloads/pgpr-master/input_renewableenergy_2/answer_matrix_overall.csv', 'w', newline='') as file:
        writer = csv.writer(file)
...
with open('/Users/smesbah/Downloads/pgpr-master/input_renewableenergy_2/answer_matrix_desirability.csv', 'w', newline='') as file:
    writer = csv.writer(file)
    writer.writerow(['idea', 'worker', 'rating'])
...
with open('/Users/smesbah/Downloads/pgpr-master/input_renewableenergy_2/answer_matrix_feasibility.csv', 'w', newline='') as file:
    writer = csv.writer(file)
    writer.writerow(['idea', 'worker', 'rating'])
    for row in list_feasibility:
        writer.writerow(row)
with open('/Users/smesbah/Downloads/pgpr-master/input_renewableenergy_2/answer_matrix_viability.csv', 'w', newline='') as file:
    writer = csv.writer(file)
    writer.writerow(['idea', 'worker', 'rating'])
    for row in list_viability:
        writer.writerow(row)

with open('/Users/smesbah/Downloads/pgpr-master/input_renewableenergy_2/answer_matrix_unlabeled_overall.csv', 'w', newline='') as file:
        writer = csv.writer(file)
        writer.writerow(['idea', 'worker', 'rating'])
        for row in list_overall_un:
            writer.writerow(row)

with open('/Users/smesbah/Downloads/pgpr-master/input_renewableenergy_2/answer_matrix_unlabeled_desirability.csv', 'w', newline='') as file:
    writer = csv.writer(file)
    writer.writerow(['idea', 'worker', 'rating'])
    for row in list_desirability_un:
        writer.writerow(row)

with open('/Users/smesbah/Downloads/pgpr-master/input_renewableenergy_2/answer_matrix_unlabeled_feasibility.csv', 'w', newline='') as file:
    writer = csv.writer(file)
    writer.writerow(['idea', 'worker', 'rating'])
    for row in list_feasibility_un:
        writer.writerow(row)
with open('/Users/smesbah/Downloads/pgpr-master/input_renewableenergy_2/answer_matrix_unlabeled_viability.csv', 'w', newline='') as file:
    writer = csv.writer(file)
    writer.writerow(['idea', 'worker', 'rating'])
...
with open('/Users/smesbah/Downloads/pgpr-master/input_renewableenergy_2/unlabeled_data_idea.csv', 'w', newline='') as file:
        writer = csv.writer(file)
